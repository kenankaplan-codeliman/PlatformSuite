...
import { useMyTasksWidget } from '../../../../entities/dashboard/api/useDashboardQueries';
import type { ActivityDigestItem } from '../../../../entities/dashboard/model/types';
import { dashboardLinks } from '../../lib/links';
import { formatDate } from '../../lib/format';

export function MyTasksWidget({ ownerOnly, onOwnerOnlyChange }: DashboardWidgetProps) {
  const { t } = useTranslation('page.dashboard');
  const navigate = useNavigate();
  const q = useMyTasksWidget(ownerOnly);
