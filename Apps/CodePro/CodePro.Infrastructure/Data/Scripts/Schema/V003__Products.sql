...
CREATE UNIQUE INDEX uq_brand_name ON brand(name) WHERE is_deleted = FALSE;
...
CREATE UNIQUE INDEX uq_manufacturer_name ON manufacturer(name) WHERE is_deleted = FALSE;
...
CREATE INDEX idx_product_keyword_product_id ON product_keyword(product_id);
