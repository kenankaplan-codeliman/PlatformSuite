...
public class PurchaseOrderLineConfiguration : IEntityTypeConfiguration<PurchaseOrderLine>
{
    public void Configure(EntityTypeBuilder<PurchaseOrderLine> builder)
    {
        ...
        builder.Property(l => l.PurchaseRequestLineId).HasColumnName("purchase_request_line_id");
        ...
        builder.HasOne(l => l.Product)
            ...
            .HasConstraintName("fk_purchase_order_line_product")
            .OnDelete(DeleteBehavior.Restrict);

        builder.HasOne(l => l.PurchaseRequestLine)
            .WithMany()
            .HasForeignKey(l => l.PurchaseRequestLineId)
            .HasConstraintName("fk_purchase_order_line_request_line")
            .OnDelete(DeleteBehavior.Restrict);

        builder.HasOne(l => l.ProductPrice)
            .WithMany()
            .HasForeignKey(l => l.ProductPriceId)
            .HasConstraintName("fk_purchase_order_line_product_price")
            .OnDelete(DeleteBehavior.Restrict);

        builder.HasMany(l => l.RequestLines)
            .WithOne(rl => rl.PurchaseOrderLine)
            .HasForeignKey(rl => rl.PurchaseOrderLineId)
            .HasConstraintName("fk_po_request_line_order_line")
