...
public static class CommunicationsMappings
{
    public static void Register(TypeAdapterConfig config)
    {
        ...
        config.NewConfig<EmailModal, EmailBase>().IgnoreAuditFields();
        config.NewConfig<PhoneModal, PhoneBase>().IgnoreAuditFields();
        config.NewConfig<AddressModal, AddressBase>().IgnoreAuditFields();
    }
}
