...
public class AuthOrganizationConfiguration : IEntityTypeConfiguration<AuthOrganization>
{
    public void Configure(EntityTypeBuilder<AuthOrganization> builder)
    {
        builder.ToTable("auth_organization");
        ...
        // Self-referencing
        builder.HasOne<AuthOrganization>()
            .WithMany()
