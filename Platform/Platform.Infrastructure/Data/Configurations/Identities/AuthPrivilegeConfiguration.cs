...
public class AuthPrivilegeConfiguration : IEntityTypeConfiguration<AuthPrivilege>
{
    public void Configure(EntityTypeBuilder<AuthPrivilege> builder)
    {
        builder.ToTable("auth_privilege");
